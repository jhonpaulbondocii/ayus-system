...
const buildCss = () => `
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .chp-main { display: flex; flex-direction: column; gap: 16px; }
  .chp-side { display: flex; flex-direction: column; gap: 16px; }
  ...
  @media (max-width: 1024px) {
    ...
    .chp-side { display: grid; grid-template-columns: 1fr 1fr; }
  }
  @media (max-width: 768px) {
    .chp-header { min-height: 90px; padding: 0 16px; }
    .chp-header-title { font-size: 17px; }
    ...
    .chp-body { padding: 14px 12px 24px; gap: 12px; }
    .chp-side { grid-template-columns: 1fr; }
    .chp-actions-grid { grid-template-columns: 1fr 1fr; }
    .chp-grade-summary { grid-template-columns: repeat(3, 1fr); }
  }
  @media (max-width: 480px) {
    .chp-actions-grid { grid-template-columns: 1fr 1fr; gap: 6px; }
    .chp-header-tab { padding: 6px 10px 7px; font-size: 10px; }
  }
`;
...
export default function CourseHomePage({ courseId, courseName: initialCourseName }: Props) {
  ...
  /* ── Fetch grading progress from existing grades API ── */
        ...
        <div className="chp-header">
          <div className="chp-header-content">
            ...
            <div className="chp-header-tabs">
              <div className="chp-header-tab active">Home</div>
              <div className="chp-header-tab" onClick={() => router.push(`/admin/courses/${courseId}/assignments`)} style={{ cursor: "pointer" }}>Assignments</div>
              <div className="chp-header-tab" onClick={() => router.push(`/admin/courses/${courseId}/grades`)} style={{ cursor: "pointer" }}>Grades</div>
              <div className="chp-header-tab" onClick={() => router.push(`/admin/courses/${courseId}/people`)} style={{ cursor: "pointer" }}>People</div>
            </div>
          </div>
        </div>
                  ...
                  <>
                    ...
                    <div className="chp-grade-summary">
                      <div className="chp-grade-stat">
                        <div className="chp-grade-stat-val" style={{ color: "#374151" }}>
                          {gradingProgress.totalSubmissions}
                        </div>
                        <div className="chp-grade-stat-label">Submitted</div>
                      </div>
                      <div className="chp-grade-stat">
                        <div className="chp-grade-stat-val" style={{ color: "#15803d" }}>
                          {gradingProgress.graded}
                        </div>
                        <div className="chp-grade-stat-label">Graded</div>
                      </div>
                      <div className="chp-grade-stat">
                        <div className="chp-grade-stat-val" style={{ color: gradingProgress.ungraded > 0 ? MAROON : "#9ca3af" }}>
                    ...
                    <div className="chp-grade-bar-wrap">
                      <div
                        className="chp-grade-bar-fill"
                        style={{ width: `${gradingProgress.gradedPct}%` }}
                      />
                    </div>
                          ...
                          .map((a) => (
                            <div key={a.id} className="chp-grade-row">
                              ...
                              <div className="chp-grade-row-mini">
                                <div
                                  className="chp-grade-row-mini-fill"
                                  style={{ width: `${pct(a.graded, a.submitted)}%` }}
                                />
                              </div>
                              <div className="chp-grade-row-count">
                    ...
                    {gradingProgress.ungraded > 0 && (
                      <div style={{ marginTop: 12, padding: "8px 12px", background: "#fef2f2", borderRadius: 8, border: "1px solid #f0c0c0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <button
                          onClick={() => router.push(`/admin/courses/${courseId}/grades`)}
                          style={{ fontSize: 11, fontWeight: 800, color: "#fff", background: MAROON, border: "none", borderRadius: 6, padding: "4px 10px", cursor: "pointer", fontFamily: FONT }}
                        >
                          Grade Now
                        </button>
                      </div>
                ...
                {loadingDeadlines ? (
                  ...
                  return (
                    <div key={d.id} className="chp-deadline-row">
                      <div
                        className="chp-deadline-icon"
                        style={{ background: isForm ? "#ecfeff" : "#fdf2f2" }}
                      >
                        {isForm ? (
                      ...
                      <div className="chp-deadline-info">
                        ...
                        <div className="chp-deadline-sub">
                          <span
                            className="chp-deadline-due"
                            style={{
                              background: dueLow ? "#fef2f2" : "#f3f4f6",
                              color: dueLow ? MAROON : "#6b7280",
                            }}
                          >
                            {d.dueDate}
                          </span>
                          <span className="chp-deadline-progress">
                            {submittedPct}% submitted
                          </span>
                        </div>
                      </div>
                      <div className="chp-deadline-right">
                        <div className="chp-deadline-frac">
                          {d.submissions}<span>/{d.total}</span>
                        </div>
