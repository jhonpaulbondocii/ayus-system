...
export async function sendInboxMessageEmail({
  ...
  const preview =
    messageBody.length > 300
      ? messageBody.slice(0, 300).trimEnd() + "…"
      : messageBody;
                    ...
                    <td style="padding:28px 24px 24px;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                          <td style="padding:20px 24px;">
                            <p style="margin:0 0 4px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#999999;">Subject</p>
                            <p style="margin:0 0 16px;font-size:14px;font-weight:700;color:#1a1a1a;">${subject}</p>

                            <p style="margin:0 0 4px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#999999;">Message</p>
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td>
                            <a href="${loginUrl}"
                               style="display:inline-block;background:#7b1113;color:#ffffff;padding:13px 28px;border-radius:4px;font-size:14px;font-weight:600;text-decoration:none;">
                              View Message in AYUS →
                            </a>
                          </td>
                        </tr>
                      </table>
