                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                              <tr>
                                <td style="padding:4px 0;width:120px;vertical-align:top;">
                                  <span style="font-size:12px;font-weight:700;color:#555;text-transform:uppercase;letter-spacing:0.4px;">Points</span>
                                </td>
                              ...
                              <tr>
                                <td style="padding:4px 0;vertical-align:top;">
                                  <span style="font-size:12px;font-weight:700;color:#555;text-transform:uppercase;letter-spacing:0.4px;">Submission</span>
                                </td>
                                <td style="padding:4px 0;">
                                  <span style="font-size:13px;color:#1a1a1a;">${submissionType}</span>
                                </td>
                              </tr>` : ""}
                              ${dueDateStr ? `
                              <tr>
                                <td style="padding:4px 0;vertical-align:top;">
                                  <span style="font-size:12px;font-weight:700;color:#7b1113;text-transform:uppercase;letter-spacing:0.4px;">Due Date</span>
                                </td>
                                <td style="padding:4px 0;">
                              ...
                              <tr>
                                <td style="padding:4px 0;vertical-align:top;">
                                  <span style="font-size:12px;font-weight:700;color:#555;text-transform:uppercase;letter-spacing:0.4px;">Available From</span>
                                </td>
                                <td style="padding:4px 0;">
                              ...
                              <tr>
                                <td style="padding:4px 0;vertical-align:top;">
                                  <span style="font-size:12px;font-weight:700;color:#555;text-transform:uppercase;letter-spacing:0.4px;">Until</span>
                                </td>
                                <td style="padding:4px 0;">
