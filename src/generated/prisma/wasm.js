...
exports.Prisma.BodySystemScalarFieldEnum = {
  id: 'id',
  courseId: 'courseId',
  name: 'name',
  order: 'order',
...
exports.Prisma.GuidanceInfoSheetScalarFieldEnum = {
  id: 'id',
  courseId: 'courseId',
  studentNo: 'studentNo',
  ...
  fatherLanguage: 'fatherLanguage',
  fatherReligion: 'fatherReligion',
  fatherOFW: 'fatherOFW',
  fatherYearsAbroad: 'fatherYearsAbroad',
  ...
  motherOFW: 'motherOFW',
  motherYearsAbroad: 'motherYearsAbroad',
  ...
  fears: 'fears',
  healthAcademics: 'healthAcademics',
  healthExtracurricular: 'healthExtracurricular',
...
exports.Prisma.GuidanceLogEntryScalarFieldEnum = {
  id: 'id',
  courseId: 'courseId',
  name: 'name',
  department: 'department',
...
exports.Prisma.ExitInterviewScalarFieldEnum = {
  ...
  dateOfBirth: 'dateOfBirth',
  feelHappy: 'feelHappy',
  feelExcited: 'feelExcited',
  feelSad: 'feelSad',
  feelNervous: 'feelNervous',
  feelChallenged: 'feelChallenged',
  feelOthers: 'feelOthers',
  influenceProfessor: 'influenceProfessor',
  influenceClassmate: 'influenceClassmate',
  influenceFriends: 'influenceFriends',
  influenceFamily: 'influenceFamily',
  influenceOthers: 'influenceOthers',
  planFindJob: 'planFindJob',
  planGradStudies: 'planGradStudies',
  planBoardExam: 'planBoardExam',
  planOthers: 'planOthers',
  honorianValues: 'honorianValues',
  pressingProblemDetails: 'pressingProblemDetails',
  likedMost: 'likedMost',
  ...
  counselorSignatureUrl: 'counselorSignatureUrl',
  counselorSignedAt: 'counselorSignedAt',
  counselorId: 'counselorId',
  studentSignatureUrl: 'studentSignatureUrl',
  studentSignedAt: 'studentSignedAt',
  photoUrl: 'photoUrl',
  status: 'status',
  submittedAt: 'submittedAt',
  updatedAt: 'updatedAt'
...
exports.Prisma.LibraryCardRequestScalarFieldEnum = {
  id: 'id',
  courseId: 'courseId',
  ...
  recipientSignedAt: 'recipientSignedAt',
  status: 'status',
  dateFiled: 'dateFiled',
...
exports.Prisma.LibraryReceivingLogScalarFieldEnum = {
  id: 'id',
  courseId: 'courseId',
  requestId: 'requestId',
  name: 'name',
...
exports.Prisma.LibraryBorrowRecordScalarFieldEnum = {
  id: 'id',
  courseId: 'courseId',
  bookId: 'bookId',
...
exports.Prisma.ModelName = {
  ...
  GuidanceInfoSheet: 'GuidanceInfoSheet',
  GuidanceLogEntry: 'GuidanceLogEntry',
