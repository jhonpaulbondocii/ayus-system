// src/app/api/guidance/[courseId]/info/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.error("[GET /guidance/info]", err);
    return NextResponse.json({ error: "Failed to load form. Please try again." }, { status: 500 });
  }
}