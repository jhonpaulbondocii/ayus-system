// src/app/api/library/[courseId]/upload/route.ts
...
export async function POST(
  ...
  try {
    ...
    if (!course || course.officeType?.toUpperCase() !== "LIBRARY" || course.status !== "PUBLISHED") {
    ...
    console.error("[POST /library/upload]", err);
